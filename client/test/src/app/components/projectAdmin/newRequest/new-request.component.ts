...
export class NewRequestComponent implements OnInit, OnDestroy {
  ...
  constructor(private fb: FormBuilder, private bcSvc: BlockchainService, private repoSvc: SqlRepositoryService, private route: ActivatedRoute, private storageSvc: SessionStorageService, private router: Router, private validatorSvc: ValidatorService) { }
